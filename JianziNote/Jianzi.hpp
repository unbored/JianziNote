...
public:
    ...
    std::vector<JianziStyler::PathData> RenderPath(const JianziStyler &styler) const;
...
protected:
    // 递归获取所有笔画
    static void CollectStrokes(const Node &node, const BoundingBox &parent_box, float stroke_width,
